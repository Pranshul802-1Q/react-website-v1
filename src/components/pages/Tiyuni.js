...
import { SliderData} from '../SliderDataTiyuni';

export default Tiyuni;
    ...
    return (
        ...
        <div class='doc-container'>
               ...
               It has roots in a piece of classical Latin literature from 45 BC, making it over 2000 years old.
                ...
                The standard chunk of Lorem Ipsum used since the 1500s is reproduced below for those interested. Sections
                 1.10.32 and 1.10.33 from "de Finibus Bonorum et Malorum" by Cicero are also reproduced in their exact original
                  ...
                  <img id='pageimg' src='/images/container-8.jpg' alt='disp'></img>
                 
          </div>

          <div className='holder'>
          <img id='pageimg' src='/images/container-10.jpg' alt='disp'></img>
            <div className='textspace'>
            <p>Contrary to popular belief, Lorem Ipsum is not simply random text.
               It has roots in a piece of classical Latin literature from 45 BC, making it over 2000 years old.
                Richard McClintock, a Latin professor at Hampden-Sydney College in Virginia, looked up one of 
          ...
          <div className='listholder'>
            <div className='list'>
            <center><h2>Item 1</h2></center>
              <p style= {{marginTop:"15px"}}>Lorem ipsum dolor sit amet,
                 consectetur adipiscing elit,
                 sed do eiusmod tempor incididunt
                 ut labore et dolore magna aliqua.
                 Tellus rutrum tellus pellentesque
                 eu tincidunt. Sed viverra ipsum 
                 nunc aliquet bibendum. Vehicula
